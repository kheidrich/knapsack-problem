...
class KnapsackGaSolution {
    ...
    initialize() {
        ...
        this.objects = objects.map(() => new KnapsackObject(
            this.utils.getRandomNumber(this.knapsackParams.minObjectValue, this.knapsackParams.maxObjectValue, 2),
            this.utils.getRandomNumber(this.knapsackParams.minObjectWeight, this.knapsackParams.maxObjectWeight, 2)
        ));
    }
